    ...
    <>
        <div className="flex justify-between">
            ...
            <main className="w-10/12 py-4 box-border h-screen overflow-hidden">
                <Header />
                <div className='bg-senary relative flex justify-center items-center h-screen'>
                  <section className='w-full font-FitSquad bg-white flex flex-col justify-center items-center rounded-md absolute px-10 top-12'>
